...
const cpContactManagement = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Contact Management Campaigns Plus' description="Efficiently organize and engage your contacts with advanced management tools, optimizing campaign outreach and effectiveness" canonical="https://www.mumara.com/campaignsplus/campaign-feature/contact-management/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query cpContactManagementBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/campaign-feature/contact-management", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
...
export default cpContactManagement

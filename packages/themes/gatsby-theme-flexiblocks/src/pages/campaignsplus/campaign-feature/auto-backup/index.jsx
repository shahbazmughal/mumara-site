...
const cpAutoBackup = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)
  return (
    <Layout theme={theme} {...props}>
      <Seo title='Auto Backup Campaigns Plus' description="Effortlessly safeguard your campaigns with automated backups, ensuring peace of mind and seamless continuity." canonical="https://www.mumara.com/campaignsplus/campaign-feature/auto-backup/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query cpAutoBackupBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/campaign-feature/auto-backup", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }

...
const cpMultithreading = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Multithreading Campaigns Plus' description="Boost campaign speed and efficiency with multithreading capabilities, ensuring swift delivery and optimal performance" canonical="https://www.mumara.com/campaignsplus/campaign-feature/multithreading/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query cpMultithreadingBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/campaign-feature/multithreading", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
...
export default cpMultithreading
...
const cpSendingNodes = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Multiple Smtps Sending Nodes Campaigns Plus' description="Elevate campaign delivery efficiency with multiple SMTPs sending nodes, ensuring rapid outreach and enhanced inbox placement." canonical="https://www.mumara.com/campaignsplus/campaign-feature/multiple-smtpssending-nodes/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query cpSendingNodesBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/campaign-feature/multiple-smtpssending-nodes", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }

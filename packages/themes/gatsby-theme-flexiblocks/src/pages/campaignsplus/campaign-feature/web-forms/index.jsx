...
const cpWebForms = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Web Forms Campaigns Plus' description="Capture leads and drive engagement with interactive web forms campaigns, seamlessly integrating user responses into your marketing strategy." canonical="https://www.mumara.com/campaignsplus/campaign-feature/web-forms/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query cpWebFormsBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/campaign-feature/web-forms", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }

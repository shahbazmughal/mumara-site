...
const cpSmartSegments = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Smart Segment Campaigns Plus' description="Optimize targeting precision and engagement with smart segment campaigns, tailoring messages to specific audience segments for maximum impact." canonical="https://www.mumara.com/campaignsplus/campaign-feature/smart-segments/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query cpSmartSegmentsBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/campaign-feature/smart-segments", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
...
export default cpSmartSegments

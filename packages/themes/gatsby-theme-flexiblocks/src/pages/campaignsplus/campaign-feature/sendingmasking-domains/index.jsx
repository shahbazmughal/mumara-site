...
const cpDomainMasking = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Sending Masking Domains Campaigns Plus' description="Enhance email deliverability and brand reputation by masking sending domains, ensuring trusted and secure communication with your audience." canonical="https://www.mumara.com/campaignsplus/campaign-feature/sendingmasking-domains/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query cpDomainMaskingBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/campaign-feature/sendingmasking-domains", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
...
export default cpDomainMasking

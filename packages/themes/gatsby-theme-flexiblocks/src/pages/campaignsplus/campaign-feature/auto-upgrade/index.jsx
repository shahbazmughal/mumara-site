...
const cpAutoUpgrade = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Auto Upgrade Campaigns Plus' description="Experience hassle-free campaign updates with our automated upgrade feature, ensuring your campaigns are always optimized and cutting-edge." canonical="https://www.mumara.com/campaignsplus/campaign-feature/auto-upgrade/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query cpAutoUpgradeBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/campaign-feature/auto-upgrade", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }

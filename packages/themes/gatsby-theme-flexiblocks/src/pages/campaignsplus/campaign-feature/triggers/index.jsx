...
const cpTriggers = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Triggers Campaigns Plus' description="Activate timely responses and personalized interactions with triggers campaigns, engaging audiences at the perfect moment for maximum impact." canonical="https://www.mumara.com/campaignsplus/campaign-feature/triggers/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query cpTriggersBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/campaign-feature/triggers", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }

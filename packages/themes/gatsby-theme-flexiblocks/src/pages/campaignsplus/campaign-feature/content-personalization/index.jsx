...
const cpContentPersonalization = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Personalized Campaigns with Mumara Campaigns Plus' description="Campaigns Plus Cotent Personalization" canonical="https://www.mumara.com/campaignsplus/campaign-feature/content-personalization/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query cpContentPersonalizationBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/campaign-feature/content-personalization", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
...
export default cpContentPersonalization

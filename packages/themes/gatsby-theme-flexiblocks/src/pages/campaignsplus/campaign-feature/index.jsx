...
const campaignsPlusFeatures = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Campaigns Plus Features' description="Unlock a suite of powerful features to supercharge your campaigns, driving engagement, and maximizing results." canonical="https://www.mumara.com/campaignsplus/campaign-feature/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query campaignsPlusFeaturesBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/campaign-feature", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
...
export default campaignsPlusFeatures

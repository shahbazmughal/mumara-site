...
const cpStaffManagement = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Staff Management Campaigns Plus' description="Efficiently coordinate and delegate tasks with staff management campaigns, ensuring seamless collaboration and streamlined workflow."  canonical="https://www.mumara.com/campaignsplus/campaign-feature/staff-management/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query cpStaffManagementBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/campaign-feature/staff-management", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
...
export default cpStaffManagement
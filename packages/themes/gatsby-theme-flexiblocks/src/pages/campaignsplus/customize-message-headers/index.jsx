...
const cpCustomizeHeaders = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Customize Message Headers' description="Engage target audience with compelling content and drive action with our latest campaign" canonical="https://www.mumara.com/campaignsplus/customize-message-headers/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query cpCustomizeHeadersBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/customize-message-headers", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
...
export default cpCustomizeHeaders
...
const campaignsPlus = props => {
  ...
  return (
    <Layout theme={theme} {...props}>
      <Seo title='Campaigns Plus' description="Empower your marketing endeavors with Campaigns Plus, delivering unparalleled efficiency and effectiveness." canonical="https://www.mumara.com/campaignsplus/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query campaignsPlusBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }

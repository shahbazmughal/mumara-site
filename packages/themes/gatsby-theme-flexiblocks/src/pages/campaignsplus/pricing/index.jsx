...
const campaignsPlusPricing = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Campaigns Plus Pricing and Packages' description="Explore flexible pricing and comprehensive packages tailored to suit your campaign needs, ensuring affordability and scalability." canonical="https://www.mumara.com/campaignsplus/pricing/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query campaignsPlusPricingBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/pricing", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
...
export default campaignsPlusPricing

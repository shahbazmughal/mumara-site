...
const cpRequestDemo = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Request a Demo of Campaigns Plus' description="Experience the power of Campaigns Plus firsthand with a personalized demo tailored to your needs and objectives." canonical="https://www.mumara.com/campaignsplus/request-demo/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query cpRequestDemoBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus/request-demo", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }

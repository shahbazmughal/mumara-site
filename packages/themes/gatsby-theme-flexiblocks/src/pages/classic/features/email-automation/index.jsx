...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Email Autoresponder | Trigger Event | MumaraClassic' description="Automate your email marketing with Mumara Classic. Streamline campaigns, enhance engagement, and save time with powerful email automation features." keywords="automatic email response,workflow automation,trigger events,sales prospecting,email automation" image="https://post.mumara.com/images/classic-features-email-automation.png" image2="https://post.mumara.com/images/classic-features-email-automation.png" canonical="https://www.mumara.com/classic/features/email-automation/" favicon="https://www.mumara.com/favicon.ico" />

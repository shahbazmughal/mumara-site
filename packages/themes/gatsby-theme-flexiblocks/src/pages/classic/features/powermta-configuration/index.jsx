...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='PowerMTA Configuration | MumaraClassic' description="Fine tune PowerMTA Configuration to ensure high volume email delivery along with accurate processing of bounced from PowerMTA logs." keywords="powermta configuration,high volume email delivery,vmta configuration,powermta smtp configuration,remote bounce processing" image="https://post.mumara.com/images/classic-features-powermta-configuration.png" image2="https://post.mumara.com/images/classic-features-powermta-configuration.png" canonical="https://www.mumara.com/classic/features/powermta-configuration/" favicon="https://www.mumara.com/favicon.ico" />

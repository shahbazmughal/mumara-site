...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Dynamic Content Tag | Behavioral Targeting | MumaraClassic' description="One of the important aspects of creating relevant content is to follow some solid content personalization methods, dynamic content is among one of these." keywords="dynamic content,content personalization,create dynamic content,behavioral marketing" image="https://post.mumara.com/images/classic-features-dynamic-content-tags.png" image2="https://post.mumara.com/images/classic-features-dynamic-content-tags.png" canonical="https://www.mumara.com/classic/features/dynamic-content-tags/" favicon="https://www.mumara.com/favicon.ico" />

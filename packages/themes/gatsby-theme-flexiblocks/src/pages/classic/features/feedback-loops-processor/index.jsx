...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Feedback Loop Processing | MumaraClassic' description="Mumara feedback loop processor addon proactively handles the spam complaints, before it actually start harming the reputation of your sending IP." keywords="feedback loop processor,fbl processing addon,spam complaints processing,handle spam complaints" image="https://post.mumara.com/images/classic-features-feedback-loops-processor.png" image2="https://post.mumara.com/images/classic-features-feedback-loops-processor.png" canonical="https://www.mumara.com/classic/features/feedback-loops-processor/" favicon="https://www.mumara.com/favicon.ico" />

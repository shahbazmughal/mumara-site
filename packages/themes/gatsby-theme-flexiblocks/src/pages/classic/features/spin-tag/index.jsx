...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Email Content Spinner | Spin Tag | MumaraClassic' description="Add variations in the content to make it relevant and somewhat unique for the contacts in the list, keeping bulk sending and content filters prospective in mind." keywords="email content spinning,content spinner,spin tags,spin email content,content spinning tool,bypass spam filters,bypass web filter" image="https://post.mumara.com/images/classic-features-spin-tag.png" image2="https://post.mumara.com/images/classic-features-spin-tag.png" canonical="https://www.mumara.com/classic/features/spin-tag/" favicon="https://www.mumara.com/favicon.ico" />

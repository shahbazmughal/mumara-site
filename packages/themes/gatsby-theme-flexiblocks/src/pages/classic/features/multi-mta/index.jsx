...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Multi MTA | Multiple SMTPs | MumaraClassic' description="Create and select multiple SMTPs to send from, separate SMTP for each campaign, rotate IPs by rotating SMTP and SMTP groups." keywords="multi mta,ip rotation,smtp rotation,multiple smtp accounts,smtp groups" image="https://post.mumara.com/images/classic-features-multi-mta.png" image2="https://post.mumara.com/images/classic-features-multi-mta.png" canonical="https://www.mumara.com/classic/features/multi-mta/" favicon="https://www.mumara.com/favicon.ico" />

...
const campaignsPlusGdpr = props => {
  const { allBlockContent } = props.data
  const content = normalizeBlockContentNodes(allBlockContent?.nodes)

  return (
    <Layout theme={theme} {...props}>
      <Seo title='Campaigns Plus GDPR' description="Safeguard data and ensure compliance with GDPR regulations seamlessly integrated into Campaigns Plus." canonical="https://www.mumara.com/campaignsplus-gdpr/" favicon="https://www.mumara.com/favicon.ico" />
...
export const query = graphql`
  query campaignsPlusGdprBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaignsplus-gdpr", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
...
export default campaignsPlusGdpr

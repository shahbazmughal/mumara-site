...
const campFeaturesUserManagement = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title="Efficient User Management with Mumara" description="Manage your email marketing team efficiently with Mumara Campaigns' user management features. Assign roles, set permissions, and streamline your workflow." keywords="Mumara User Management, user access, permissions, user roles, streamline workflow" canonical="https://www.mumara.com/campaigns/features/user-management/" favicon="https://www.mumara.com/favicon.ico" />

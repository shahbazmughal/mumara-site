...
const campFeatures18= props => {
  ...
  return (
    <Layout theme={theme} {...props}>
      <Seo title='AB Testing Tool | Split Testing' description="Significantly improve result by testing different variants of your email campaign and finding out which version performs the best." keywords="multivariate testing,split testing,ab testing,best email campaign" canonical="https://www.mumara.com/campaigns/features/split-testing/" favicon="https://www.mumara.com/favicon.ico" />

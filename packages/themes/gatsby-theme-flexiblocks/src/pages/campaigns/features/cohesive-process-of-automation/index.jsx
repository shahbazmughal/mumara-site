...
const campFeatures04 = props => {
  ...
  return (
    <Layout theme={theme} {...props}>
      <Seo title='Autoresponder | Drip Email Marketing' description="Nurture leads, use Autoresponders function to create series of auto follow ups and setup drip campaigns to be delivered automatically at preset criteria and time interval." keywords="lead nurturing,drip campaign,autoresponder,follow up emails,drip email campaign" canonical="https://www.mumara.com/campaigns/features/cohesive-process-of-automation/" favicon="https://www.mumara.com/favicon.ico" />

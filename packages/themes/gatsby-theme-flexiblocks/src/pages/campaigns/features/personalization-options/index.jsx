  ...
  return (
    <Layout theme={theme} {...props}>
      <div className="innerpage-main">
        <Seo title='Personalized Email | Dynamic Content' description="Use custom variables and tools like dynamic content tags or spintag to target right audience with personalized email and diverse content every-time." keywords="personalized email marketing,custom email,dynamic content,purchasing patterns,email content spinner,custom variables" canonical="https://www.mumara.com/campaigns/features/personalization-options/" favicon="https://www.mumara.com/favicon.ico" />

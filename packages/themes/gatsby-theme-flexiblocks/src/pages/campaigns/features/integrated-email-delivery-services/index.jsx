...
const campFeatures11= props => {
  ...
  return (
    <Layout theme={theme} {...props}>
      <Seo title='Integrated Email Delivery Services | Campaigns' description="Campaigns has integrated all globally acknowledged email relay services for its clients to be able to seamlessly connect to the desired one for sending." keywords="integrated,email delivery,services" canonical="https://www.mumara.com/campaigns/features/integrated-email-delivery-services/" favicon="https://www.mumara.com/favicon.ico" />

...
const campFeatures08 = props => {
  ...
  return (
    <Layout theme={theme} {...props}>
      <Seo title='Drag and Drop Email Builder | Campaigns' description="Create stunning emails effortlessly with Mumara Campaigns' Drag and Drop Email Builder. Design, customize, and engage with ease." keywords="email builder, drag and drop, email marketing, Mumara Campaigns" canonical="https://www.mumara.com/campaigns/features/email-builder/" favicon="https://www.mumara.com/favicon.ico" />

...
const campFeatures12= props => {
  ...
  return (
    <Layout theme={theme} {...props}>
      <Seo title='Configure SMTP Server | Sending Nodes' description="Configure your account to send from SMTP server or Mail Service of your choice, setup Multiple SMTP accounts, and sending nodes to send according to your preferences." keywords="smtp server,mail server,amazon ses,sendgrid smtp server,remote email services" canonical="https://www.mumara.com/campaigns/features/multiple-smtpssending-nodes/" favicon="https://www.mumara.com/favicon.ico" />

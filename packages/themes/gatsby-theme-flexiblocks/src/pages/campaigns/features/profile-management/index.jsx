...
const campFeaturesProfileManagement = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Customize Your Email Experience | Mumara Profile Management' description="Customize and manage user profiles with Mumara Campaigns. Streamline settings, enhance security, and optimize your email marketing workflows." keywords="Mumara Profile Management, email customization, user settings, preferences, personalization" canonical="https://www.mumara.com/campaigns/features/profile-management/" favicon="https://www.mumara.com/favicon.ico" />

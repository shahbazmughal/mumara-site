...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Add IPs to Server | Assign IPs | SMS' description="Optimize your email deliverability with Mumara Classic ESP. Manage IPs and IP blocks effortlessly to ensure reliable and secure email sending." keywords="ips management,add ip blocks,manage mail sending ips,sender ip,shared ips,dedicated ips" image="https://post.mumara.com/images/classic-esp-manage-ips-ip-blocks.png" image2="https://post.mumara.com/images/classic-esp-manage-ips-ip-blocks.png" canonical="https://www.mumara.com/classic-esp/manage-ips-ip-blocks/" favicon="https://www.mumara.com/favicon.ico" />

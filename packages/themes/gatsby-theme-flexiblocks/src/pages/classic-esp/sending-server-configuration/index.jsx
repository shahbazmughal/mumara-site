...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='PowerMTA Sending Server | ESP Mail Server | SMS' description="Configure your email sending servers with ease using Mumara Classic ESP. Optimize deliverability, manage settings, and ensure reliable email campaigns." keywords="powermta sending server,powermta config,esp and powermta,email delivery expert" image="https://post.mumara.com/images/classic-esp-sending-server-configuration.png" image2="https://post.mumara.com/images/classic-esp-sending-server-configuration.png" canonical="https://www.mumara.com/classic-esp/sending-server-configuration/" favicon="https://www.mumara.com/favicon.ico" />

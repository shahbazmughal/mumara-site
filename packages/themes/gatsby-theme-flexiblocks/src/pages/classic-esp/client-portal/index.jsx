...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Feature Rich Email Portal | SMS' description="The client side portal offers extensive list of features for email marketing management and automation. Every registered client separately login to the email portal." keywords="email marketing automation,contact and list management,email segmentation tool,data driven email marketing" image="https://post.mumara.com/images/classic-esp-client-portal.png" image2="https://post.mumara.com/images/classic-esp-client-portal.png" canonical="https://www.mumara.com/classic-esp/client-portal/" favicon="https://www.mumara.com/favicon.ico" />

...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Client Account Management | SMS' description="Enhance your email marketing services with Mumara Classic ESP's client management features. Manage multiple clients, customize settings, and streamline operations" keywords="email clients,client management,client groups,client email limits,email credit management" image="https://post.mumara.com/images/classic-esp-client-management.png" image2="https://post.mumara.com/images/classic-esp-client-management.png" canonical="https://www.mumara.com/classic-esp/client-management/" favicon="https://www.mumara.com/favicon.ico" />

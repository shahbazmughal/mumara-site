...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='SMS Masking | Sender ID | SMS' description="Get the offered picked by sending it from the Sender ID belonging to your company or brand name, apply numeric or alphanumeric Sender ID of upto 11 characters." keywords="branded sms,sender id,improved open rates,alphanumeric sender id,custom sender id" image="https://post.mumara.com/images/sms-features-sender-id.png" image2="https://post.mumara.com/images/sms-features-sender-id.png" canonical="https://www.mumara.com/sms/sms-features/sender-id/" favicon="https://www.mumara.com/favicon.ico" />

...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Admin Staff | Better Customer Service | SMS' description="Add admin staff users to be an administrative assistant in performing several administrative tasks and responsibilities to ensure time and better customer service." keywords="admin staff management,better customer service,timely customer support,administrative assistant" image="https://post.mumara.com/images/smsplus-adminstaff-management.png" image2="https://post.mumara.com/images/smsplus-adminstaff-management.png" canonical="https://www.mumara.com/smsplus/admin-staff-management/" favicon="https://www.mumara.com/favicon.ico" />

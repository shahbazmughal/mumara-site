...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Control Spam SMS | Mobile Carriers List | SMS' description="Explore powerful tools with Mumara SMSPlus. Enhance your SMS marketing campaigns with automation, analytics, and robust messaging features." keywords="spam sms,spam words,multilingual,mobile carriers list,mnc mcc,mobile network code list" image="https://post.mumara.com/images/smsplus-tools.png" image2="https://post.mumara.com/images/smsplus-tools.png" canonical="https://www.mumara.com/smsplus/tools/" favicon="https://www.mumara.com/favicon.ico" />

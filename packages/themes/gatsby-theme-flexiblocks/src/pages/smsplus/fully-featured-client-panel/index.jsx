...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Client Panel | Client Dashboard | SMS' description="Similar to the admin side the client panel of SMSplus is loaded with everything that your client would need to compose, send and scale text engagement campaigns." keywords="client panel,client platform,text engagement campaigns,sms platform" image="https://post.mumara.com/images/smsplus-fully-featured-client-panel.png" image2="https://post.mumara.com/images/smsplus-fully-featured-client-panel.png" canonical="https://www.mumara.com/smsplus/fully-featured-client-panel/" favicon="https://www.mumara.com/favicon.ico" />

...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Billing System Integration | Recurring Payments | SMS' description="SMSplus offers seamless integration of WHMCS billing system to manage recurring payments, invoicing and payment processing." keywords="billing system,recurring payments,integrated payment gateways,payment processing,whmcs" image="https://post.mumara.com/images/smsplus-billing-system-integration.png" image2="https://post.mumara.com/images/smsplus-billing-system-integration.png" canonical="https://www.mumara.com/smsplus/billing-system-integration/" favicon="https://www.mumara.com/favicon.ico" />

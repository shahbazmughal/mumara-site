...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Gateway Redundancy | Priority Zone | SMS' description="Setup gateway priority for geographically distributed zones and networks operating within these countries to effectively cut the text message cost." keywords="destination zones,sending priority zones,cut text message cost,network priority" image="https://post.mumara.com/images/smsplus-priority-zones.png" image2="https://post.mumara.com/images/smsplus-priority-zones.png" canonical="https://www.mumara.com/smsplus/priority-zones/" favicon="https://www.mumara.com/favicon.ico" />

...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Reverse Lookup Service | SMS' description="Ensure the accuracy of your SMS campaigns with Mumara SMSPlus Validation Module. Validate numbers, reduce bounce rates, and improve deliverability." keywords="reverse lookup service,minimize message send failure,identify mobile carrier,network based priority" image="https://post.mumara.com/images/smsplus-validation-module.png" image2="https://post.mumara.com/images/smsplus-validation-module.png" canonical="https://www.mumara.com/smsplus/validation-module/" favicon="https://www.mumara.com/favicon.ico" />

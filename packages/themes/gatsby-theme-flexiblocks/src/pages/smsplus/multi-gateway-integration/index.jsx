...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='SMS Gateway APIs | SMS' description="Configure your SMS service with SMS gateway provider of your choice, SMSplus has integrated bunch of globally acknowledged SMS gateway APIs." keywords="sms gateway api,sms api,sms gateway,clickatell integrated,infobip integrated,twilio integrated" image="https://post.mumara.com/images/smsplus-multi-gateway-integration.png" image2="https://post.mumara.com/images/smsplus-multi-gateway-integration.png" canonical="https://www.mumara.com/smsplus/multi-gateway-integration/" favicon="https://www.mumara.com/favicon.ico" />

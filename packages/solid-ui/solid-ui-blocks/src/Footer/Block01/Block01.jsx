...
import dcma from './_dmca_premi_badge_4.png'
        ...
        <Flex sx={styles.footer} xs={styles.listBlk} className="footerJoint">
          <Box sx={{ minWidth: 200 }}>
            ...
            <Box pt='2' mb={[2, 4]}>
              ...
              <Box>
                <GLink to="https://www.dmca.com/Protection/Status.aspx?ID=994c3354-60b0-4def-8dfa-882e801d2cbc" title="DMCA.com Protection Status"><img src={dcma} alt="DMCA.com Protection Status" width="135px" height="28px" /></GLink>
              </Box>
            </Box>
            <Box>

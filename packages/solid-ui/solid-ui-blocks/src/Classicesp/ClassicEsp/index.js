                    ...
                    {`
                        {
                            ...
                            "itemListElement": [{
                                ...
                                "position": 2,
                                "name": "Classic ESP",
                                "item": "https://www.mumara.com/classic-esp"
                            }]
                        }
                    `}
                </script>
            ...
            <div className="seo-block" style={{display: "none"}}>
                <ol itemScope itemType="http://schema.org/BreadcrumbList">
                    ...
                    <li itemProp="itemListElement" itemScope
                        ...
                        itemProp="item" itemID="https://www.mumara.com/classic-esp/"
                        href="https://www.mumara.com/classic-esp/">
                        <span itemProp="name">Classic ESP</span>
                        <img itemProp="image" src="https://post.mumara.com/images/mumara-home.jpg" alt="Classic ESP"/></a>
                ...
                <div className="schemaproduct" itemScope itemType="http://schema.org/Product">
                    ...
                    <span itemProp="name">Classic ESP</span>
                    <img itemProp="image" src="https://post.mumara.com/images/mumara-home.jpg" alt="Classic ESP" />
                    ...
                    <meta itemProp="sku" content="classic-esp-1947" />
                ...
                <div itemScope itemType="https://schema.org/SoftwareApplication">
                    ...
                    <div itemProp="aggregateRating" itemScope itemType="https://schema.org/AggregateRating">
                        ...
                        <span itemProp="ratingCount">1077</span> ratings )
                    </div>
                    <div itemProp="offers" itemScope itemType="https://schema.org/Offer">
                        Price: $<span itemProp="price">119.99</span>
                        <meta itemProp="priceCurrency" content="USD" />
                    </div>
                </div>
            </div>

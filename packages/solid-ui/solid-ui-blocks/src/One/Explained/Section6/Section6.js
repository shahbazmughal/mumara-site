...
export default function Section6() {
  ...
  return (
    <div className="one-section one-section-6" style={{backgroundImage: `url(${bg6})`}}>
      <div className="container">
        <div className="row">
          <div className="col-md-12 section6-box max-w950 m-auto mb-5">
            <div className="col-md-12 section6-box-inn">

...
import bg28 from './images/bg28.jpg';
...
export default function Section28() {
  ...
  return (
    <div className="one-section one-section-28" style={{backgroundImage: `url(${bg28})`}}>
      <div className="container">
        <div className="row">
          <div className="col-md-12 section28-box max-w950 m-auto">
            <div className="col-md-12 section28-box-inn">

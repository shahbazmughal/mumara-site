...
import bg24 from "./images/bg24.svg";
...
export default function Section24() {
  ...
  return (
    <div className="one-section one-section-24" style={{ backgroundImage: `url(${bg24})` }}>
      <div className="container">
        <div className="row">
          <div className="col-md-12 section24-box max-w950 m-auto">
            <div className="section24-box-inn">

            ...
            <div className="seo-block" style={{display: "none"}}>
                <ol itemScope itemType="http://schema.org/BreadcrumbList">
                    ...
                    <li itemProp="itemListElement" itemScope
                        ...
                        <img itemProp="image" src="https://post.mumara.com/images/mumara-home.jpg" alt="Mumara ONE | Mumara"/></a>
                        <meta itemProp="position" content="2" />
                    </li>
                </ol>
                <div className="schemaproduct" itemScope itemType="http://schema.org/Product">
                    <meta itemProp="mpn" content="974717" />
                    <span itemProp="brand">Mumara</span>
                    <span itemProp="name">Mumara ONE</span>
                    <img itemProp="image" src="https://post.mumara.com/images/mumara-home.jpg" alt="Mumara ONE" />
                    ...
                    <span itemProp="ratingValue">5.0</span> stars, based on <span itemProp="reviewCount">347
                        </span> reviews
                    </span>
                    ...
                    <meta itemProp="sku" content="one-7" />
                ...
                <div itemScope itemType="https://schema.org/SoftwareApplication">
                    ...
                    <div itemProp="aggregateRating" itemScope itemType="https://schema.org/AggregateRating">
                        ...
                        <span itemProp="ratingCount">347</span> ratings )
                    </div>

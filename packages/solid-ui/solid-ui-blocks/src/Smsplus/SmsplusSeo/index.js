                    ...
                    {`
                        {
                            ...
                            "itemListElement": [{
                                ...
                                "position": 2,
                                "name": "SMS+",
                                "item": "https://www.mumara.com/smsplus"
                            }]
                        }
                    `}
                </script>
            ...
            <div className="seo-block" style={{display: "none"}}>
                <ol itemScope itemType="http://schema.org/BreadcrumbList">
                    ...
                    <li itemProp="itemListElement" itemScope
                        ...
                        itemProp="item" itemID="https://www.mumara.com/smsplus"
                        href="https://www.mumara.com/smsplus">
                        <span itemProp="name">SMS+</span>
                        <img itemProp="image" src="https://post.mumara.com/images/mumara-home.jpg" alt="SMS+ | Mumara"/></a>
                ...
                <div className="schemaproduct" itemScope itemType="http://schema.org/Product">
                    ...
                    <span itemProp="name">SMS+</span>
                    <img itemProp="image" src="https://post.mumara.com/images/mumara-home.jpg" alt="Mumara SMS+" />
                    ...
                    <meta itemProp="sku" content="sms-947" />
                ...
                <div itemScope itemType="https://schema.org/SoftwareApplication">
                    ...
                    <div itemProp="aggregateRating" itemScope itemType="https://schema.org/AggregateRating">
                        ...
                        <span itemProp="ratingCount">1197</span> ratings )
                    </div>
                    <div itemProp="offers" itemScope itemType="https://schema.org/Offer">
                        Price: $<span itemProp="price">47</span>
                        <meta itemProp="priceCurrency" content="USD" />
                    </div>
                </div> 
            </div>

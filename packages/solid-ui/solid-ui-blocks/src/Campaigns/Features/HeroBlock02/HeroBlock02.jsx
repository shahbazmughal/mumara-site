...
const scrollToDown =()=> {
  document.getElementById("orderarea").scrollIntoView()
}
      ...
      {buttons && (
        <div className="text-center mb-10">
          <Reveal effect='fadeInUp' duration={0.7}>
            <Link to="#orderarea" className="button-group-button level-1 css-12g6cok" title="Get Started with Mumara Campaigns">
              <div className="css-12hibeq text-white">
        ...
        <div className="text-center"><img src="/static/cc-bd0b3d96125f33ea7a06a69efba7cc3f.png" className="img-responsive m-auto" alt="Get Started with Mumara Campaigns" /></div>
    </section>
  </div>
)
